-- ============================================================================
-- MENU MASTER NG — 001_correctness_and_isolation.sql (Supabase SQL Editor build)
--
-- DISPOSABLE PROJECT ONLY. Never run against production.
-- Generated by scripts/build_supabase_suites.sh from tests/001_correctness_and_isolation.sql.
