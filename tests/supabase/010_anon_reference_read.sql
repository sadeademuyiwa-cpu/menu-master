-- ============================================================================
-- MENU MASTER NG — 010_anon_reference_read.sql (Supabase SQL Editor build)
--
-- DISPOSABLE PROJECT ONLY. Never run against production.
-- Generated by scripts/build_supabase_suites.sh from tests/010_anon_reference_read.sql.
