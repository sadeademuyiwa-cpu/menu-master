-- ============================================================================
-- MENU MASTER NG — 002_gate1_attack_and_regression.sql (Supabase SQL Editor build)
--
-- DISPOSABLE PROJECT ONLY. Never run against production.
-- Generated by scripts/build_supabase_suites.sh from tests/002_gate1_attack_and_regression.sql.
